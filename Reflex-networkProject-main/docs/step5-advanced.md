...
این مرحله اجباریه و 20 نمره داره (15 نمره برای قابلیت‌های اجباری + 5 نمره امتیازی برای قابلیت‌های اضافی). باید Traffic Morphing رو پیاده‌سازی کنی و می‌تونی یکی از قابلیت‌های پیشرفته دیگه رو هم اضافه کنی.
